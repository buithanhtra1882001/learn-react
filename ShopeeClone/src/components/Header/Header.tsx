...
export default function Header() {
  ...
  // Chứ không bị unmount - mounting agian
  ...
  const { data: purchasesInCartData } = useQuery({
    // alias name `data thành purchasesInCartData`
          ...
          <div className='col-span-1 justify-self-end'>
                ...
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  {purchasesInCart ? (
                    ...
                    <div className='flex h-[240px] w-[400px] flex-col items-center justify-center p-2'>
                      <img src={noproduct} alt='Emtry Cart' className='h-24 w-24' />
            ...
            >
              <Link to='/' className='relative'>
                ...
                {purchasesInCart && (
                  <span className='absolute left-[16px] top-[-4px] rounded-full bg-white px-[10px] py-[1px] text-xs text-orange '>
