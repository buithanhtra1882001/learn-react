...
export default function ProductDetail() {
  ...
  const { data: productsData } = useQuery({
    ...
    staleTime: 3 * 60 * 1000 // Có thể set `staleTime là vô hạn với Infinity
  })
          ...
          <div className='grid grid-cols-12 gap-9'>
            <div className='col-span-5'>
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-1'>
                <button
                  className='2-5 absolute left-0 top-1/2 z-10 h-9 -translate-y-1/2 bg-black/20 text-white'
                  onClick={prevImage}
                >
                  <svg
                ...
                <button
                  className='2-5 absolute right-0 top-1/2 z-10 h-9 -translate-y-1/2 bg-black/20 text-white'
                  onClick={nextImage}
                >
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
              ...
              <div className='mt-8 flex items-center'>
                <div className='flex items-center'>
                  ...
                  <ProductRating
                    ...
                    activeClassname='fill-orange w-4 h-4 text-orange'
                    nonActiveClassname='fill-gray-300 w-4 h-4 text-gray-300'
                  />
                </div>
