  ...
  return (
    <div className='pd-10 rounded-sm bg-white px-2 shadow md:px-7 md:pb-20'>
      <div className='border-b border-b-gray-200 py-3'>
        ...
        <div className='my-1 text-sm text-gray-700'>Quản lý thông tin hồ sơ để bảo mật tài khoản</div>
      </div>
        ...
        <div className='mt-6 flex-grow md:mt-0 md:pr-12'>
          <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
            ...
            <div className='sm:w-[80%] sm:pl-5'>
              <Input
                classNameInput=' rouded-sm w-full border border-gray-300 px-3 py-2 outline-none focus:border-gray-500 focus:shadow-md'
                className='relative'
                register={register}
                name='password'
                type='password'
          ...
          <div className='mb-5 mt-4 flex flex-col flex-wrap sm:flex-row'>
