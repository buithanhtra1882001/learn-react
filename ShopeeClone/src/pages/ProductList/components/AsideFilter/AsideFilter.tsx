...
export default function AsideFilter({ queryConfig, categories }: AsideFilterProps) {
  ...
  const handleRemoveAllFilterLeft = () => {
    reset()
    navigate({
      pathname: path.home,
  ...
  return (
    <div className='py-4'>
              ...
              render={({ field }) => {
                return (
                  <InputNumber
                    ...
                    className='grow'
                    placeholder='₫ TỪ'
                    classNameInput='rouded-sm w-full border border-gray-300 p-1 outline-none focus:border-gray-500 focus:shadow-md'
      ...
      <Button
        ...
        onClick={handleRemoveAllFilterLeft}
      >
        Xóa tất cả
      </Button>
    </div>
