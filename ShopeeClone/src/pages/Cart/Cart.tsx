    ...
    <div className='bg-neutral-100 py-16'>
      <div className='container'>
        {extendedPurchases.length > 0 ? (
            ...
            <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-50 bg-white p-5 shadow sm:flex-row sm:items-center'>
              ...
              <div className='mt-5 flex flex-col sm:ml-auto sm:mt-0 sm:flex-row sm:items-center'>
                ...
                <Button
                  ...
                  className='mt-5 flex h-10 w-52 items-center justify-center bg-red-500 text-sm capitalize text-white hover:bg-red-600 sm:ml-4 sm:mt-0'
                >
                  Mua hàng
                </Button>
              </div>
          ...
          <div className='flex items-center justify-center'>
            <div className='flex h-[240px] w-[400px] flex-col items-center justify-center p-2'>
              <img src={noproduct} alt='Emtry Cart' className='h-32 w-32' />
              <div className='mt-3 font-bold capitalize text-gray-400'>Giỏ hàng của bạn còn trống</div>
              <Link
                to={path.home}
                className='mt-5 rounded bg-orange px-10 py-2  text-xl uppercase text-white transition-all hover:bg-orange/80'
              >
                {' '}
                Mua ngay
              </Link>
